          ...
          {[
            ...
            <div key={key}>
              ...
              <input
                ...
                style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "4px", padding: "12px 14px", color: "#F5F0E8", fontSize: "14px", outline: "none", boxSizing: "border-box" }}
              />
            </div>
          ))}
